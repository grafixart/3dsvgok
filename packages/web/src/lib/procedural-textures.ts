 ...
 * =============================================================================
 *
 * 10 canvas-based texture generators (marble, wood, carbon fiber, etc.)
 * that return data URLs for use as Three.js texture maps.
 */

export interface TexturePreset {
  name: string;
  generate: () => string; // returns a data URL
}

function createCanvas(size: number = 512): [HTMLCanvasElement, CanvasRenderingContext2D] {
...
function noise(ctx: CanvasRenderingContext2D, size: number, scale: number, seed: number = 42) {
